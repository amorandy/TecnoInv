...
if(isset($_GET['edit'])){
    $sql = "SELECT * FROM validadores WHERE id = '".$_GET['id']."'";
    ...
    $cl = update_validador($_POST['upname'],$_POST['upemail'],$_POST['uppassword'],$_POST['upstatus'],$_GET['edit']);
...
if(isset($_POST['name'])){
    ...
    $cl = register_validador($_POST['name'],$_POST['email'],$_POST['password'],$_POST['status']);
    if($cl){
...
$tabla2 = ("SELECT id,name,email,status FROM validadores ORDER BY id DESC"); 
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="validador?id=<?php echo $registro['id']; ?>&edit=1"><i class="fa fa-pencil" aria-hidden="true"></i>
</a></td>
                                            </tr>
<?php 
} 
