...
$sql = "SELECT total,name FROM clientes WHERE id = '$id'";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-primary">Dashboard > Registro de: <b><?php echo $nameC; ?></b></h4> </div>
...
$tabla2 = ("SELECT * FROM transfers WHERE cliente_id = '$id'"); 
